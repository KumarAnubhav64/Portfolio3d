...
export function Astronaut(props) {
  ...
  useEffect(() => {if (animations.length>0) {actions[animations[0].name].play()}}, [animations, actions])
...
YSpring.set(-1)
  ...
  return (
    <group ref={group} {...props} rotation={[-Math.PI / 2, -0.2, 2.2]} scale={props.scale|| 0.3} position={props.position || [1.3,-1,0]} dispose={null}>
