    ...
    <div className='z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text'>
      ...
      <div className='flex-col  hidden md:flex  c-space'>
        <motion.h1 className='text-4xl font-medium'
          ...
          animate="visible"
          transition={{ delay: 1 }}
        >Hi I am Kumar Anubhav</motion.h1>
        <div className='flex flex-col items-start'>
          ...
          > A Developer <br /> Dedicated to Coding</motion.p>
          <motion.div
            variants={variants}
            initial="hidden"
            animate="visible"
      ...
      <div className='flex flex-col space-y-2 md:hidden'>
        <motion.p className='text-4xl font-medium'
          ...
          animate="visible"
          transition={{ delay: 1 }}
        > Hi, I'm Kumar Anubahv</motion.p>
        <motion.p className='text-5xl font-black text-white'
          variants={variants}
          initial="hidden"
          animate="visible"
          transition={{ delay: 1.2 }}
        ...
        <motion.div
          ...
          animate="visible"
          transition={{ delay: 1.4 }}>
          <FlipWords words={words} className='text-7xl font-black text-white' />
        </motion.div>
